...
Because this product is still in beta status, issues specific to the Ingres Ruby
...
active support contract can raise an issue through their local support center.
